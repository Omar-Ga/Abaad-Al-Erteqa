          ...
          <div *ngFor="let project of projects()" 
            ...
            <div class="p-6 flex-1 flex flex-col">
              ...
              <dl class="space-y-0 text-sm flex-1 border-t border-gray-100">
                <!-- Owner -->
                <div *ngIf="project.ownerName" class="grid grid-cols-[90px_1px_1fr] py-3 border-b border-gray-100">
                  <dt class="font-medium text-gray-500 flex items-center justify-end text-end px-3">{{ config.labelOwner }}</dt>
                  <div class="h-full bg-gray-200"></div>
                  <dd class="font-semibold text-gray-900 px-4 flex items-center">{{ project.ownerName }}</dd>
                </div>
                
                <!-- Location -->
                <div *ngIf="project.location" class="grid grid-cols-[90px_1px_1fr] py-3 border-b border-gray-100">
                  <dt class="font-medium text-gray-500 flex items-center justify-end text-end px-3">{{ config.labelLocation }}</dt>
                  <div class="h-full bg-gray-200"></div>
                  <dd class="font-semibold text-gray-900 px-4 flex items-center">{{ project.location }}</dd>
                </div>

                <!-- Size -->
                <div *ngIf="project.size" class="grid grid-cols-[90px_1px_1fr] py-3 border-b border-gray-100">
                  <dt class="font-medium text-gray-500 flex items-center justify-end text-end px-3">{{ config.labelSize }}</dt>
                  <div class="h-full bg-gray-200"></div>
                  <dd class="font-semibold text-gray-900 px-4 flex items-center">{{ project.size }}</dd>
                </div>

                <!-- Office Role -->
                <div *ngIf="project.officeRoleTemp" class="grid grid-cols-[90px_1px_1fr] py-3 border-b border-gray-100">
                  <dt class="font-medium text-gray-500 flex items-center justify-end text-end px-3">{{ config.labelOfficeRole }}</dt>
                  <div class="h-full bg-gray-200"></div>
                  <dd class="font-semibold text-gray-900 px-4 flex items-center">{{ project.officeRoleTemp }}</dd>
                </div>

                <!-- Price -->
                <div *ngIf="project.price" class="grid grid-cols-[90px_1px_1fr] py-3 border-b border-gray-100">
                  <dt class="font-medium text-gray-500 flex items-center justify-end text-end px-3">{{ config.labelPrice }}</dt>
                  <div class="h-full bg-gray-200"></div>
